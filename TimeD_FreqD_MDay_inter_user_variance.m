...
for nc = 1:10
    ...
    T_Acc_Data_Day2 = load(sprintf('U%02d_Acc_TimeD_FreqD_MDay.mat', nc));
    
    % Extract the specific data of size (36x43)
    Temp_Acc_Data = T_Acc_Data_Day2.Acc_TDFD_Feat_Vec(1:36, 1:131);
...
% Initialize an empty array to store variances for features (36x131)
...
% Calculate the average variance across all 36 rows for each of the 131 features
