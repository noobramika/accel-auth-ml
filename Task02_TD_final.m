...
for checking_user = 1:10
    ...
    checking_user_feat = [Acc_TD_Data_Day1{checking_user}; Acc_TD_Data_Day2{checking_user}];
    ...
    for nc = 1:10
        if nc ~= checking_user
            non_checking_user_feat = [Acc_TD_Data_Day1{nc}; Acc_TD_Data_Day2{nc}];
...
fprintf('User-wise Accuracy, EER, FAR, FRR, AUC, and Selected FPR/TPR:\n');
for user = 1:10
