...
for user = 1:10
    T_Acc_Data_Day1 = sprintf('U%02d_Acc_FreqD_FDay.mat', user);
    T_Acc_Data_Day2 = sprintf('U%02d_Acc_FreqD_MDay.mat', user);
    
    % this will load the Day 1 data
    load(T_Acc_Data_Day1);
    data_day1 = Acc_TD_Feat_Vec(1:36, 1:43);
    ...
    data_day2 = Acc_TD_Feat_Vec(1:36, 1:43);
    % this calculates intra user variance
    intra_user_variance_day2 = var(data_day2, 0, 2);
...
% this will calculate and display the average intra user variance for 2 days
